...
defined('PX') ? NULL : define('PX', 'katus_');
 ...
 * */
defined('ROOT_URL') ? null : define('ROOT_URL', 'http://ubuntu.ametikool.ee/~TAK15_Liik/katused/');
defined('ROOT_PATH') ? null :
    define('ROOT_PATH', DS . 'home'.DS.'TAK15_Liik'.DS.'public_html'.DS.'katused'.DS);
...
if(file_exists($langFile)) {
    ...
    require_once INCLUDE_PATH . "languages" . DS . 'et.php';
}
